    ...
    <>
      <div className="flax w-full h-screen">
        ...
        <div className="relative w-full h-[90%] lg:h-[70%] xl:h-[50%] bottom-0 mt-4">
          ...
          >
            <h1
              className={`${statusAns[0] ? "text-gray-50" : "text-gray-600"} `}
            >
          ...
          >
            <h1
              className={`${statusAns[1] ? "text-gray-50" : "text-gray-600"} `}
            >
          ...
          >
            <h1
              className={`${statusAns[2] ? "text-gray-50" : "text-gray-600"} `}
            >
          ...
          >
            <h1
              className={`${statusAns[3] ? "text-gray-50" : "text-gray-600"} `}
            >
